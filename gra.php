...
if (!isset($_SESSION['zalogowany'])) // jesli nie ma sesji logowania
{
...
if ($serverdatetime < $validuntil)
	echo "Premium days left: ".$premiumdaysleft -> format('%y years, %m months, %d days, %h hours, %i minutes, %s seconds');
else echo "Premium inactive since: ".$premiumdaysleft -> format('%y years, %m months, %d days, %h hours, %i minutes, %s seconds');
